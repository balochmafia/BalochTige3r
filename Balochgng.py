...
jalan("\033[1;93m Welcome to Zulfiqar Baloch Creations")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:zulfiqar
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('https://www.facebook.com/zulfiqar.baloch.9047506')
    else:
